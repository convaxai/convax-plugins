import{createHash as D}from"node:crypto";function L(o){let n=(e)=>{if(e===null||typeof e==="string"||typeof e==="boolean")return e;if(typeof e==="number"){if(!Number.isFinite(e))throw TypeError("canonical JSON rejects non-finite numbers");return Object.is(e,-0)?0:e}if(Array.isArray(e))return e.map(n);if(typeof e==="object"){let i=e;return Object.fromEntries(Object.keys(i).sort().map((s)=>{if(i[s]===void 0)throw TypeError("canonical JSON rejects undefined");return[s,n(i[s])]}))}throw TypeError(`canonical JSON rejects ${typeof e}`)};return JSON.stringify(n(o))}function R(o){return D("sha256").update(o).digest("hex")}var on="https://static.modelcontextprotocol.io/schemas/2025-12-11/server.schema.json",rn="3fba09590c99f61735d234822279f4223fab9e300c0a81e81c91ab62a4114de0";var pn=new TextEncoder().encode(`{
