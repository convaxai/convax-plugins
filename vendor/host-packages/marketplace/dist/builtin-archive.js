import{createHash as bn}from"node:crypto";function A(o){let n=(t)=>{if(t===null||typeof t==="string"||typeof t==="boolean")return t;if(typeof t==="number"){if(!Number.isFinite(t))throw TypeError("canonical JSON rejects non-finite numbers");return Object.is(t,-0)?0:t}if(Array.isArray(t))return t.map(n);if(typeof t==="object"){let p=t;return Object.fromEntries(Object.keys(p).sort().map((i)=>{if(p[i]===void 0)throw TypeError("canonical JSON rejects undefined");return[i,n(p[i])]}))}throw TypeError(`canonical JSON rejects ${typeof t}`)};return JSON.stringify(n(o))}function X(o){return bn("sha256").update(o).digest("hex")}import Hn from"ajv";var Yn=new TextEncoder().encode(`{
...
//# debugId=B53134B7A0F0B06564756E2164756E21
