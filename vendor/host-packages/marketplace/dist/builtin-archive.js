...
`);var on=/^[0-9a-f]{64}$/;var _n=/^(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)\.(0|[1-9][0-9]*)(?:-[0-9A-Za-z-]+(?:\.[0-9A-Za-z-]+)*)?(?:\+[0-9A-Za-z-]+(?:\.[0-9A-Za-z-]+)*)?$/;var Ln=/^[a-z0-9]+(?:-[a-z0-9]+)*$/;var tn=new Hn({strict:!0,strictRequired:!1,allErrors:!1,coerceTypes:!1,useDefaults:!1,removeAdditional:!1,validateFormats:!1});tn.addKeyword({keyword:"example",valid:!0});var Jn=tn.compile(nn);function q(o,n){if(o===null||typeof o!=="object"||Array.isArray(o))throw TypeError(`${n} must be an object`);return o}function k(o,n,t,p){for(let i of Object.keys(o))if(!n.includes(i))throw TypeError(`${p} has unknown property ${i}`);for(let i of t)if(!(i in o))throw TypeError(`${p} is missing ${i}`)}function S(o,n,t=4096){if(typeof o!=="string"||o.length===0||o.length>t)throw TypeError(`${n} must be a non-empty string of at most ${t} characters`);return o}function yn(o,n,t=Number.MAX_SAFE_INTEGER){if(!Number.isSafeInteger(o)||o<0||o>t)throw TypeError(`${n} must be a non-negative safe integer`);return o}function Un(o,n){let t=S(o,n,64);if(!on.test(t))throw TypeError(`${n} must be a lowercase SHA-256 digest`);return t}function pn(o){let n=q(o,"Builtin bundle");if(k(n,["schema","release","members"],["schema","release","members"],"Builtin bundle"),n.schema!=="convax.builtin-bundle/1")throw TypeError("unsupported Builtin bundle schema");let t=q(n.release,"Builtin release");if(k(t,["id"],["id"],"Builtin release"),!Array.isArray(n.members)||n.members.length===0||n.members.length>128)throw TypeError("Builtin members must be a bounded non-empty array");let p=new Set,i=new Set,R=n.members.map((T)=>{let g=q(T,"Builtin member");if(k(g,["kind","id","version","artifact","presentation"],["kind","id","version","artifact","presentation"],"Builtin member"),g.kind!=="plugin"&&g.kind!=="skill")throw TypeError("Builtin V1 admits only Plugin and Skill");let b=(x,u)=>{let m=q(x,u);k(m,["path","size","sha256"],["path","size","sha256"],u);let r=S(m.path,`${u}.path`,256);if(!/^([A-Za-z0-9._-]+\/)*[A-Za-z0-9._-]+$/.test(r)||r.includes(".."))throw TypeError(`${u}.path is unsafe`);if(p.has(r))throw TypeError(`duplicate Builtin artifact path ${r}`);p.add(r);let L=yn(m.size,`${u}.size`,134217728);if(L<1)throw TypeError(`${u}.size must be positive`);return{path:r,size:L,sha256:Un(m.sha256,`${u}.sha256`)}},H=S(g.id,"Builtin member id",200);if(!Ln.test(H)||H.length>80)throw TypeError("Builtin member id must be a lowercase slug");let I=`${g.kind}\x00${H}`;if(i.has(I))throw TypeError(`duplicate Builtin member ${g.kind}/${H}`);i.add(I);let _=q(g.presentation,"Builtin member presentation");k(_,["poster","animation"],["poster"],"Builtin member presentation");let e=(x,u)=>{let m=q(x,u);k(m,["path","mime","size","sha256"],["path","mime","size","sha256"],u);let r=S(m.mime,`${u}.mime`,100);if(!(u==="Builtin poster"?new Set(["image/png","image/jpeg","image/webp"]):new Set(["video/mp4","video/webm"])).has(r))throw TypeError(`${u}.mime is unsupported`);return{...b({path:m.path,size:m.size,sha256:m.sha256},u),mime:r}};return{kind:g.kind,id:H,version:(()=>{let x=S(g.version,"Builtin member version",255);if(!_n.test(x))throw TypeError("Builtin member version must be SemVer");return x})(),artifact:b(g.artifact,"Builtin member artifact"),presentation:{poster:e(_.poster,"Builtin poster"),..._.animation===void 0?{}:{animation:e(_.animation,"Builtin animation")}}}}),j=(()=>{let T=S(t.id,"Builtin release id",64);if(!on.test(T))throw TypeError("Builtin release id must be a lowercase content SHA-256");return T})(),F=Z(X(R));if(j!==F)throw TypeError("Builtin release id must equal the canonical member content digest");return{schema:"convax.builtin-bundle/1",release:{id:j},members:R}}var en=134217728,hn=125829120,qn=512,kn=1048576,Sn=/^([A-Za-z0-9._-]+\/)*[A-Za-z0-9._-]+$/,Fn=(()=>{let o=new Uint32Array(256);for(let n=0;n<256;n++){let t=n;for(let p=0;p<8;p++)t=t&1?3988292384^t>>>1:t>>>1;o[n]=t>>>0}return o})();function Mn(o){let n=4294967295;for(let t of o)n=Fn[(n^t)&255]^n>>>8;return(n^4294967295)>>>0}function h(o,n,t){if(n<0||n+2>o.byteLength)throw TypeError(`Builtin ZIP ${t} is truncated`);return o.getUint16(n,!0)}function c(o,n,t){if(n<0||n+4>o.byteLength)throw TypeError(`Builtin ZIP ${t} is truncated`);return o.getUint32(n,!0)}function Pn(o){let n;try{n=new TextDecoder("utf-8",{fatal:!0}).decode(o)}catch{throw TypeError("Builtin ZIP entry name is not valid UTF-8")}if(!n||n.length>256||!Sn.test(n)||n.split("/").some((t)=>t===".."))throw TypeError(`Builtin ZIP entry path is unsafe: ${n}`);return n}function Wn(o,n){return o<n?-1:o>n?1:0}function un(o,n={}){let t=n.maxTotalEntryBytes??hn;if(!Number.isSafeInteger(t)||t<1||t>hn)throw TypeError("Builtin ZIP aggregate byte budget must be a positive bounded integer");if(o.byteLength<22||o.byteLength>en)throw TypeError("Builtin ZIP exceeds its bounded archive size");let p=new DataView(o.buffer,o.byteOffset,o.byteLength),i=o.byteLength-22;if(c(p,i,"EOCD signature")!==101010256)throw TypeError("Builtin ZIP must end with an exact EOCD");let R=h(p,i+4,"disk"),j=h(p,i+6,"central disk"),F=h(p,i+8,"disk entry count"),T=h(p,i+10,"entry count"),g=c(p,i+12,"central size"),b=c(p,i+16,"central offset"),H=h(p,i+20,"comment length");if(R!==0||j!==0||F!==T||T<1||T>qn||H!==0||b+g!==i)throw TypeError("Builtin ZIP has unsupported multi-disk, count, comment, or central-directory shape");let I=new Map,_=new Set,e=b,x=0,u="",m=0;for(let s=0;s<T;s++){if(c(p,e,"central signature")!==33639248)throw TypeError("Builtin ZIP central directory is malformed");let M=h(p,e+4,"central version made by"),$=h(p,e+6,"central version needed"),y=h(p,e+8,"central flags"),J=h(p,e+10,"central method"),D=h(p,e+12,"central modified time"),E=h(p,e+14,"central modified date"),V=c(p,e+16,"central CRC"),N=c(p,e+20,"central compressed size"),P=c(p,e+24,"central size"),W=h(p,e+28,"central name length"),z=h(p,e+30,"central extra length"),C=h(p,e+32,"central comment length"),rn=h(p,e+34,"central disk start"),fn=h(p,e+36,"central internal attributes"),B=c(p,e+38,"central external attributes"),f=c(p,e+42,"local offset"),K=e+46+W+z+C;if(M!==798||$!==20||y!==2048||J!==0||D!==0||E!==33||N!==P||P>en||W<1||z!==0||C!==0||rn!==0||fn!==0||B!==27525120&&B!==32309248||K>i)throw TypeError("Builtin ZIP admits only bounded deterministic stored entries");let d=o.subarray(e+46,e+46+W),U=Pn(d);if(I.has(U)||u&&Wn(u,U)>=0)throw TypeError("Builtin ZIP entries must be unique and canonically ordered");let v=U.toLocaleLowerCase("en-US");if(_.has(v))throw TypeError("Builtin ZIP entry paths must be unique on case-insensitive filesystems");if(_.add(v),u=U,f!==x||c(p,f,"local signature")!==67324752)throw TypeError("Builtin ZIP local records must be contiguous and match the central directory");let mn=h(p,f+4,"local version needed"),cn=h(p,f+6,"local flags"),gn=h(p,f+8,"local method"),sn=h(p,f+10,"local modified time"),jn=h(p,f+12,"local modified date"),In=c(p,f+14,"local CRC"),xn=c(p,f+18,"local compressed size"),Tn=c(p,f+22,"local size"),G=h(p,f+26,"local name length"),a=h(p,f+28,"local extra length"),l=f+30+G+a,Q=l+P;if(mn!==$||cn!==y||gn!==J||sn!==D||jn!==E||In!==V||xn!==N||Tn!==P||G!==W||a!==0||Q>b)throw TypeError("Builtin ZIP local entry metadata does not match its central entry");if(!o.subarray(f+30,f+30+G).every(($n,Rn)=>$n===d[Rn]))throw TypeError("Builtin ZIP local entry name does not match its central entry");let O=o.subarray(l,Q);if(Mn(O)!==V)throw TypeError(`Builtin ZIP CRC mismatch for ${U}`);if(m+=O.byteLength,m>t)throw TypeError("Builtin ZIP aggregate uncompressed bytes exceed the archive budget");I.set(U,O),x=Q,e=K}if(e!==i||x!==b)throw TypeError("Builtin ZIP contains unindexed or trailing entry bytes");let r=I.get("bundle.json");if(!r||r.byteLength>kn)throw TypeError("Builtin ZIP must contain one bounded bundle.json");let L;try{L=JSON.parse(new TextDecoder("utf-8",{fatal:!0}).decode(r))}catch{throw TypeError("Builtin bundle.json is not valid UTF-8 JSON")}let A=pn(L),w=new TextEncoder().encode(`${X(A)}
`);if(r.byteLength!==w.byteLength||!r.every((s,M)=>s===w[M]))throw TypeError("Builtin bundle.json must use the exact canonical JSON encoding");let Y=new Set(["bundle.json"]);for(let s of A.members){let M=[s.artifact,s.presentation.poster,...s.presentation.animation?[s.presentation.animation]:[]];for(let $ of M){let y=I.get($.path);if(!y||y.byteLength!==$.size||Z(y)!==$.sha256)throw TypeError(`Builtin bundle asset does not match bundle.json: ${$.path}`);Y.add($.path)}}if(Y.size!==I.size||[...I.keys()].some((s)=>!Y.has(s)))throw TypeError("Builtin ZIP contains assets not declared by bundle.json");return{bundle:A,entries:I}}function Nn(o,n={}){return un(o,n).bundle}function zn(o,n){let{bundle:t,entries:p}=un(o);if(n.bundleReleaseId!==t.release.id)throw TypeError("Builtin delivery belongs to another bundle release");if(!t.members.find((j)=>j.artifact.path===n.path&&j.artifact.size===n.size&&j.artifact.sha256===n.sha256)){let j=t.members.find((F)=>F.artifact.path===n.path);throw TypeError(j?"Builtin delivery size or SHA-256 does not match its verified bundle member":"Builtin delivery path does not match a verified bundle member")}let R=p.get(n.path);if(!R)throw TypeError("Builtin delivery member bytes are missing");return R.slice()}function Cn(o,n){let t=o.members.find((p)=>p.kind===n.kind&&p.id===n.id);if(!t)throw TypeError(`Builtin bundle does not contain ${n.kind}/${n.id}`);return{kind:"builtin-artifact",bundleReleaseId:o.release.id,path:t.artifact.path,size:t.artifact.size,sha256:t.artifact.sha256}}export{zn as readBuiltinBundleMember,Cn as projectBuiltinMemberDelivery,Nn as parseBuiltinBundleArchive};

//# debugId=35AE101D77B39CD964756E2164756E21
