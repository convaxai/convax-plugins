...
**Files:**
- Modify: `/path/to/convax/packages/desktop/src/main/pet-window.test.ts`
- Modify: `/path/to/convax/packages/desktop/src/main/pet-window.ts`
...
**Files:**
- Modify: `/path/to/convax/packages/desktop/src/main/agent-activity-controller.test.ts`
- Modify: `/path/to/convax/packages/desktop/src/main/agent-activity-controller.ts`
...
**Files:**
- Modify: `/path/to/convax/packages/desktop/src/pet-contracts.ts`
- Modify: `/path/to/convax/packages/desktop/src/main/pet-ipc.ts`
- Modify: `/path/to/convax/packages/desktop/src/main/pet-ipc.test.ts`
- Modify: `/path/to/convax/packages/desktop/src/preload/index.ts`
- Modify: `/path/to/convax/packages/desktop/src/renderer/env.d.ts`
...
**Files:**
- Modify: `/path/to/convax/packages/desktop/src/renderer/agent-panel-state.ts`
- Modify: `/path/to/convax/packages/desktop/src/renderer/agent-panel-state.test.ts`
- Modify: `/path/to/convax/packages/desktop/src/renderer/agent-panel.tsx`
- Modify: `/path/to/convax/packages/desktop/src/renderer/agent-panel.test.tsx`
- Modify: `/path/to/convax/packages/desktop/src/renderer/index.tsx`
...
**Files:**
- Create: `/path/to/convax/packages/desktop/src/main/pet-activity-notifier.ts`
- Create: `/path/to/convax/packages/desktop/src/main/pet-activity-notifier.test.ts`
- Modify: `/path/to/convax/packages/desktop/src/main/index.ts`
...
Run from `/path/to/convax-plugins`:
