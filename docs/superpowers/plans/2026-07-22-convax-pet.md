...
- `/path/to/convax-plugins` on `codex/convax-pet`, based on local `main`.
- `/path/to/convax` on `codex/convax-pet`, based on local `convax-next`.
...
**Repository:** `/path/to/convax-plugins`
